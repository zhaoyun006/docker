 ...
 * @since 1.0
 */
@Repository("com.cloud.sms.docker.ci.dao.DockerCloudCiAutoBuildDao")
public class DockerCloudCiAutoBuildDao extends BaseDao<DockerCloudCiAutoBuildEntity>{
     ...
     */
     public PagingResult<DockerCloudCiAutoBuildEntity> findAll(SearchMap searchMap, PageBounds pageBounds, String sqlId){
        return mybatisDaoContext.findForPage(this.getClass().getName()+"."+sqlId,DockerCloudCiAutoBuildEntity.class,searchMap,pageBounds);
     }
    ...
    public List<DockerCloudCiAutoBuildEntity> getListData(SearchMap searchMap,  String sqlId){
        return mybatisDaoContext.findAll(this.getClass().getName()+"."+sqlId,DockerCloudCiAutoBuildEntity.class,searchMap);
    }}