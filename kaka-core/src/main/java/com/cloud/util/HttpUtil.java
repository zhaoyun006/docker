...
public class HttpUtil {
     ...
     * @throws IOException
     */
    public static String  httpPostJson(String url, String content, String method){
        try {
            URL console = new URL(url);
     ...
     * @throws IOException
     */
    public static String  sendHttpsRequest(String url, String content, String method)
