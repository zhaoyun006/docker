 ...
 * @since 1.0
 */
@Repository("com.cloud.sms.docker.ci.dao.DockerCloudReleaseRecordDao")
public class DockerCloudReleaseRecordDao extends BaseDao<DockerCloudReleaseRecordEntity>{
     ...
     */
     public PagingResult<DockerCloudReleaseRecordEntity> findAll(SearchMap searchMap, PageBounds pageBounds, String sqlId){
        return mybatisDaoContext.findForPage(this.getClass().getName()+"."+sqlId,DockerCloudReleaseRecordEntity.class,searchMap,pageBounds);
     }
    ...
    public List<DockerCloudReleaseRecordEntity> getListData(SearchMap searchMap,  String sqlId){
        return mybatisDaoContext.findAll(this.getClass().getName()+"."+sqlId,DockerCloudReleaseRecordEntity.class,searchMap);
    }}