 ...
 * @since 1.0
 */
@Repository("com.cloud.sms.docker.ci.dao.DockerCloudCiEnvPermissionsDao")
public class DockerCloudCiEnvPermissionsDao extends BaseDao<DockerCloudCiEnvPermissionsEntity>{
     ...
     */
     public PagingResult<DockerCloudCiEnvPermissionsEntity> findAll(SearchMap searchMap, PageBounds pageBounds, String sqlId){
        return mybatisDaoContext.findForPage(this.getClass().getName()+"."+sqlId,DockerCloudCiEnvPermissionsEntity.class,searchMap,pageBounds);
     }
    ...
    public List<DockerCloudCiEnvPermissionsEntity> getListData(SearchMap searchMap,  String sqlId){
        return mybatisDaoContext.findAll(this.getClass().getName()+"."+sqlId,DockerCloudCiEnvPermissionsEntity.class,searchMap);
    }}