...
public class DockerCommandEntity {
    ...
    private String noproc;
    private String pidLimit;

    public String getPidLimit() {
        return pidLimit;
    }

    public void setPidLimit(String pidLimit) {
    ...
    public String getNoproc() {
        return noproc;
    }

    public void setNoproc(String noproc) {
        this.noproc = noproc;
    }
